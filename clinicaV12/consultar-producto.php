...
<center>
    <div class="contenido">
        <h2 class="let" style="margin: 20px; font-size: 40px; ">Consultar Productos</h2>
        <div class="linea"></div>
        <div class="row table-responsive">
            ...
            <table style="width: 90%;" class="display" id="mostrardatos" >
              <thead style="background-color: rgba(44,161,177,0.80);">
                <tr>
                  <th scope="col" class="">Id Producto</th>
            ...
            while ($mostrar=mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td><?php echo $mostrar['Prepro']; ?></td>
                     <td><?php echo $mostrar['Precli']; ?></td>
                    <td><?php echo $mostrar['Proveedor']; ?></td>
                    <td><?php echo $mostrar['Foto']; ?></td>

                    <td><a href="modificar-producto.php?IdProducto=<?php echo $mostrar['IdProducto']; ?>"><i class="fas fa-edit"></i></a></td>


                    <td><a style="width: 90px;"  href="#" data-href="eliminarproducto.php?IdProducto=<?php echo $mostrar['IdProducto']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                <?php 
            }
            ?>
