...
$insertar = "UPDATE `terapia` SET `Terapia` = '$Terapia', `Beneficios` = '$Beneficios', `Descripcion` = '$Descripcion', `Duracion` = '$Descripcion', `Precio` = '$Precio' WHERE `IdTerapia` ='$IdTerapia'";
