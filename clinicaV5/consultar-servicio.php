...
if (!empty($_POST)) {
    $valor=$_POST['campo'];
    if (!empty($valor)) {
        $where="WHERE Terapia='$valor'";
    }
    echo $valor;
}

$sql="SELECT * FROM 'terapia' $where";
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
         <table class="tab-datos">
            <tr>
                ...
                <td><input class=" txt" type="txt" id="campo" name="campo" placeholder="Buscar" required /></td>
                <td><input class="btn btn-info" type="submit" name="enviar" id="enviar" value="Buscar"></td>
                <td><td><a href="Agregar-servicio.html" class="btn btn-primary">Agregar</td></td>
            </tr>
        </table>
        </form>
        <div>
