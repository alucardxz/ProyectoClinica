...
<center>
    <div class="contenido">
        <h2 class="let" style="margin: 20px; font-size: 40px; ">Agregar Cita</h2>
        <div class="linea"></div>

        <div class="row table-responsive">
            <table>
                   <tr><td style="background-color:  rgba(44,161,177,0.80);"> <label style="font-size: 22px; color: black">  Seleccione Paciente para agregar cita  </label></td>
                    </tr>
            </table>
          ...
          <tbody>
            ...
            while ($mostrar=mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td><a href="agendar-cita.php?IdPaciente=<?php echo $mostrar['IdPaciente']; ?>"><center><img src="iconos/calendario.ico"></i></a></td>
                </tr>
                <?php 
            }
            ?>
