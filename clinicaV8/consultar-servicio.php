        ...
        <div class="row table-responsive">
            ...
            <table style="width: 90%;" class="display" id="mostrardatos" >
              <thead style="background-color: rgba(44,161,177,0.80);">
                <tr>
                  <th scope="col" class="">Id Terapia</th>
          ...
          <tbody>
            ...
            while ($mostrar=mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td><a href="modificaSer.php?IdTerapia=<?php echo $mostrar['IdTerapia']; ?>"><i class="fas fa-edit"></i></a></td>


                    <td><a style="width: 90px;"  href="#" data-href="eliminarservicio.php?IdTerapia=<?php echo $mostrar['IdTerapia']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                <?php 
            }
            ?>
