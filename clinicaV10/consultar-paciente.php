        ...
        <div class="row table-responsive">
            ...
            <table style="width: 90%;" class="display" id="mostrardatos" >
              <thead style="background-color: rgba(44,161,177,0.80);">
                <tr>
                  <th scope="col" class="">Id Paciente</th>
          ...
          <tbody>
            ...
            while ($mostrar=mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td><a href="modificarPaciente.php?IdPaciente=<?php echo $mostrar['IdPaciente']; ?>"><i class="fas fa-edit"></i></a></td>


                    <td><a style="width: 90px;"  href="#" data-href="eliminarpaciente.php?IdPaciente=<?php echo $mostrar['IdPaciente']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                <?php 
            }
            ?>
